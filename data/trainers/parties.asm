...
YoungsterData:
; Route 3
	db 19, KRABBY, VOLTORB, VULPIX, ODDISH, 0
	db 20, FEAROW, FEAROW, FEAROW, FEAROW, 0
; Mt. Moon 1F
	db 19, RATICATE, SANDSHREW, EXEGGCUTE, 0
; Route 24
	db 20, RATICATE, GROWLITHE, STARYU, 0
; Route 25
	db 20, FEAROW, HORSEA, KADABRA, 0
	db 20, SLOWPOKE, SLOWPOKE, CHANSEY, 0
...
BugCatcherData:
; Viridian Forest
	db 11, WEEDLE, CATERPIE, BEEDRILL, BUTTERFREE, 0
	db $FF, 12, VENONAT, 12, PARAS, 12, VENONAT, 0
	db $FF, 12, SCYTHER, 12, PINSIR, 0
; Route 3
	db $FF, 18, BEEDRILL, 18, BUTTERFREE, 0
	db 18, PARAS, BEEDRILL, VENONAT, 0
	db 19, SCYTHER, SCYTHER, SCYTHER, 0
; Mt. Moon 1F
	db 23, BEEDRILL, 0
	db 23, BUTTERFREE,  0
; Route 24
...
; Viridian Forest
	db 11, WEEDLE, CATERPIE, BEEDRILL, BUTTERFREE, 0
; Victory Road - Talos
	db 69, RAICHU, KABUTOPS, STARMIE, BLASTOISE, 0

LassData:
; Route 3
	db 20, PIDGEOTTO, FEAROW, 0
	db 19, RATICATE, NIDORINO, NIDORINA, 0
	db 20, JIGGLYPUFF, JIGGLYPUFF, JIGGLYPUFF, WIGGLYTUFF, 0
; Route 4
	db 30, PARASECT, GLOOM, PARASECT, 0
; Mt. Moon 1F
	db 20, BELLSPROUT, ODDISH, IVYSAUR, 0
	db 19, CLEFAIRY, CLEFAIRY, CLEFAIRY, CLEFABLE, 0
; Route 24
	db 20, NIDOQUEEN, 0
	db 21, CLEFABLE, WIGGLYTUFF, 0
; Route 25
	db 24, WIGGLYTUFF, 0
	db 20, IVYSAUR, CHARMELEON, WARTORTLE, 0
; SS Anne 1F Rooms
...
; Route 24/Route 25
	db 21, DODUO, PSYDUCK, 0
; Route 24
	db 21, MANKEY, VENONAT, 0
; Unused
	db 20, SQUIRTLE, 0
; Route 6
...
; Rock Tunnel B1F
	...
	db 25, SLOWPOKE, 0
; Victory Road 2F
	db 69, VENUSAUR, LAPRAS, LICKITUNG, 0
; Rock Tunnel 1F
...
; Mt. Moon B2F
	db 19, OMANYTE, KABUTO, AERODACTYL, 0
; Route 8
...
; Route 25
	db 21, HITMONCHAN, GEODUDE, 0
	db 20, SANDSHREW, ZUBAT, MANKEY, GEODUDE, 0
	db 24, ONIX, 0
; Route 9
...
; Victory Road - Sable
	db 69, AERODACTYL, PARASECT, JOLTEON, ARCANINE, 0
...
; Victory Road - Disq
	db 69, FLAREON, TENTACRUEL, NINETALES, DEWGONG, 0
...
; Victory Road - ReaderDragon
	db 69, HYPNO, MAGMAR, PERSIAN, TAUROS, 0
...
; Victory Road 2F - Regi
	db 69, TANGELA, SANDSLASH, LICKITUNG, ARBOK, 0
; Unused
...
; Victory Road 2F - Brice
	db 69, POLIWRATH, DODRIO, MACHAMP, PINSIR, 0
...
RocketData:
; Mt. Moon B2F
	db 20, ZUBAT, MAGMAR, 0
	db 20, RATICATE, JYNX, 0
	db 20, KOFFING, ELECTABUZZ, 0
; Unused
	db 16, RATICATE, 0
; Cerulean City
	db 26, HYPNO, 0
; Route 24
	db 21, EKANS, RHYHORN, 0
; Game Corner
...
; Jessie & James
	db $FF, 19, EKANS, 22, MEOWTH, 19, KOFFING, 0 ; Mt. Moon B2F
...
; Victory Road 3F - Karlos, Tiberius
	db 69, CHARIZARD, MAGNETON, TENTACRUEL, RHYDON, 0
	db 69, NIDOKING, CHARIZARD, VILEPLUME, SLOWBRO, 0
; Unused
	db 45, KINGLER, STARMIE, 0
; Victory Road 1F - Aero
	db 69, ELECTABUZZ, SNORLAX, EXEGGUTOR, SCYTHER, SLOWBRO, PORYGON, 0
; Unused
...
BrockData:
	db $FF, 12, OMANYTE, 11, VULPIX, 11, ZUBAT, 14, ONIX, 0
; Rematch
...
; Pokémon Tower 2F
	db $FF, 41, HAUNTER, 44, ALAKAZAM, 43, MAGMAR, 42, DEWGONG, 43, VICTREEBEL, 44, JOLTEON, 0
	db $FF, 41, HAUNTER, 44, ALAKAZAM, 43, HITMONCHAN, 42, CLOYSTER, 43, EXEGGUTOR, 44, FLAREON, 0
	db $FF, 41, HAUNTER, 44, ALAKAZAM, 43, SCYTHER, 42, GOLDUCK, 43, PORYGON, 44, VAPOREON, 0
; Silph Co. 7F
...
Rival3Data: 
; Champion's Room
	db $FF, 70, ALAKAZAM, 72, JOLTEON, 72, BLASTOISE, 70, ARCANINE, 70, DODRIO, 70, MEWTWO, 0
	db $FF, 70, MAGNETON, 70, NIDOQUEEN, 70, ALAKAZAM, 72, FLAREON, 70, VENUSAUR, 70, MEWTWO, 0
	db $FF, 70, MACHAMP, 70, ALAKAZAM, 70, VICTREEBEL, 72, VAPOREON, 70, CHARIZARD, 70, MEWTWO, 0
; Rematch
	db $FF, 77, ALAKAZAM, 76, MACHAMP, 75, GYARADOS, 74, PIDGEOT, 75, EXEGXGUTOR, 77, ARCANINE, 0
