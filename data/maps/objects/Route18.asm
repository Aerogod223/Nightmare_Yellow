...
Route18_Object:
	...
	def_object_events
	object_event 24,  9, SPRITE_COOLTRAINER_M, STAY, UP, TEXT_ROUTE18_COOLTRAINER_M1, OPP_BIRD_KEEPER, 8
	object_event 14,  6, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_ROUTE18_COOLTRAINER_M2, OPP_BIRD_KEEPER, 9
	object_event 42, 10, SPRITE_COOLTRAINER_M, STAY, LEFT, TEXT_ROUTE18_COOLTRAINER_M3, OPP_BIRD_KEEPER, 10
