...
VictoryRoad1F_Object:
	...
	object_event  7, 10, SPRITE_YOUNGSTER, STAY, DOWN, TEXT_VICTORYROAD1F_BUG_CATCHER, OPP_BUG_CATCHER, 16
	object_event 12, 16, SPRITE_BEAUTY, STAY, UP, TEXT_VICTORYROAD1F_BEAUTY, OPP_BEAUTY, 16
	object_event 16,  6, SPRITE_SUPER_NERD, STAY, LEFT, TEXT_VICTORYROAD1F_BURGLAR, OPP_BURGLAR, 10
