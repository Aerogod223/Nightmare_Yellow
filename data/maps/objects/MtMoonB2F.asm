...
MtMoonB2F_Object:
	...
	object_event 15, 26, SPRITE_ROCKET, STAY, DOWN, TEXT_MTMOONB2F_ROCKET1, OPP_ROCKET, 2
	object_event 25, 11, SPRITE_ROCKET, STAY, UP, TEXT_MTMOONB2F_ROCKET2, OPP_ROCKET, 3
	object_event 20, 17, SPRITE_ROCKET, STAY, LEFT, TEXT_MTMOONB2F_ROCKET3, OPP_ROCKET, 1
