...
ViridianForest_Object:
	...
	object_event 19, 16, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_VIRIDIANFOREST_YOUNGSTER3, OPP_BUG_CATCHER, 2
	...
	object_event 15, 16, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_VIRIDIANFOREST_YOUNGSTER5, OPP_BUG_CATCHER, 15
