...
Route17_Object:
	...
	def_object_events
	object_event  5,  3, SPRITE_BIKER, STAY, LEFT, TEXT_ROUTE17_BIKER1, OPP_CUE_BALL, 4
	object_event  6,  3, SPRITE_BIKER, STAY, RIGHT, TEXT_ROUTE17_BIKER2, OPP_CUE_BALL, 5
	object_event  4, 37, SPRITE_BIKER, STAY, LEFT, TEXT_ROUTE17_BIKER3, OPP_BIKER, 8
	object_event  7, 37, SPRITE_BIKER, STAY, RIGHT, TEXT_ROUTE17_BIKER4, OPP_BIKER, 3
	object_event 14, 37, SPRITE_BIKER, STAY, RIGHT, TEXT_ROUTE17_BIKER5, OPP_BIKER, 10
	object_event 18, 58, SPRITE_BIKER, STAY, LEFT, TEXT_ROUTE17_BIKER6, OPP_CUE_BALL, 6
	object_event  1, 88, SPRITE_BIKER, STAY, RIGHT, TEXT_ROUTE17_BIKER7, OPP_CUE_BALL, 7
	...
	object_event  8, 143, SPRITE_BIKER, STAY, RIGHT, TEXT_ROUTE17_BIKER10, OPP_BIKER, 12
